 ...
 */
public abstract class FactoryMethodPizzaStore2 {

    public FactoryMethodPizza2 orderPizza(String type){
        FactoryMethodPizza2 pizz ;
     ...
     *
     */
    protected abstract FactoryMethodPizza2 createPizza(String type);
